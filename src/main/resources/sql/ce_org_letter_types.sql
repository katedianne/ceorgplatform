...
CREATE TABLE `letter_types` (
  `letter_type_id` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `letter_types_ibfk_1` FOREIGN KEY (`status_id`) REFERENCES `statuses` (`status_id`)
...
INSERT INTO `letter_types` VALUES (1,'Academic Affairs',NULL,NULL,NULL,'AA');
